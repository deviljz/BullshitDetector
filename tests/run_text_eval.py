...
TEXT_CASES = [
    ...
    # ── 半真半假类：真实事件开头 + 捏造结局 ────────────────────────────────────
    {
        "id": "fake_halftruth_01_japan_iran_killed",
        "label": "日本呼吁伊朗放人 + 伊朗称被美军炸死（半真半假谣言）",
        "text": (
            "日本呼吁伊朗归还被逮捕的两名日本公民，"
            "伊朗称两人已经被美军炸死。"
        ),
        ...
        "expected_bs_min": 70,
        "reason": (
            "前半句属实：2026年3月日本确有两名公民（含NHK记者川岛伸介）被伊朗拘押，日本外相要求释放。"
            "后半句伪造：日本外务省2月28日美以打击后已与两人联系并确认平安；"
            "HRW 3月13日仍在要求'释放'而非追责死亡；伊朗无任何官方声明称其被炸死。"
            "典型'真开头+假结局'套路，煽动美日伊矛盾情绪。"
        ),
    },
]
